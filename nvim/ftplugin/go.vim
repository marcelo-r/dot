...
" remaps gd, let CoC or lsp handle it
let g:go_def_mapping_enabled = 1
" remaps K, let CoC or lsp handle
...
let g:go_metalinter_autosave_enabled = ['vet', 'revive', 'errcheck', 'gosimple', 'unused', 'ineffassign', 'lll', 'staticcheck', 'prealloc', 'gomnd', 'goconst', 'gosec', 'funlen']
